...
public class Robot extends TimedRobot {
  ...
  private final MotorController leftMaster = new CANSparkMax(1, MotorType.kBrushed);
  private final MotorController leftSlave = new CANSparkMax(2, MotorType.kBrushed);
  private final MotorController rightMaster = new CANSparkMax(3, MotorType.kBrushed);
  private final MotorController rightSlave = new CANSparkMax(4, MotorType.kBrushed);
